...
import "github.com/PickHD/LezPay/wallet/internal/v1/helper"
...
func loadConfiguration() *Configuration {
	return &Configuration{
		...
		Midtrans: &Midtrans{
			ServerKey: helper.GetEnvString("MIDTRANS_SERVER_KEY"),
			ClientKey: helper.GetEnvString("MIDTRANS_CLIENT_KEY"),
			ApiURL:    helper.GetEnvString("MIDTRANS_API_URL"),
		},
	}
}
