...
func (cr *CustomerRepositoryImpl) CreateCustomer(req *model.CreateCustomerRequest) (int64, bool, error) {
	...
	if err != nil {
		...
		if err.Error() == pgx.ErrNoRows.Error() {
			...
			sql := `
					INSERT INTO 
						customer (full_name,email,phone_number,password,pin,is_verified) 
					VALUES 
						($1,$2,$3,$4,$5,$6) RETURNING id
					`

			row := tx.QueryRow(cr.Context, sql, req.FullName, req.Email, req.PhoneNumber, req.Password, req.Pin, false)
